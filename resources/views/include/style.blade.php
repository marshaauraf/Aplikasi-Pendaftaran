...
<link rel="shortcut icon" href="{{ asset('template/assets/images/logo/keroppii.png')}}" type="image/x-icon">
<link rel="shortcut icon" href="{{ asset('template/assets/images/logo/keroppii.png')}}" type="image/png">
